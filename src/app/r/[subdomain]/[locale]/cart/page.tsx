...
export default function SubdomainCartPage() {
  ...
  const menuLink = tableFromUrl ? `${prefix}/menu?table=${tableFromUrl}` : `${prefix}/menu`;
  const confirmUrl = tableFromUrl ? `${prefix}/confirm?table=${tableFromUrl}` : `${prefix}/confirm`;
    ...
    <div className="min-h-screen bg-stone-50 pb-32">
      <header className="bg-white border-b border-stone-200 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <Link href={menuLink} className="text-emerald-600 font-medium">
            ← Menyu
          </Link>
