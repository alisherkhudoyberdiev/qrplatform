...
export default function SubdomainStatusPage() {
    ...
    <div className="min-h-screen bg-stone-50 pb-8">
      <header className="bg-white border-b border-stone-200">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <Link href={menuHref} className="text-amber-600 font-medium hover:text-amber-700">
            ← Menyu
          </Link>
          <h1 className="text-xl font-semibold text-stone-800 mt-2">Buyurtma holati</h1>
          <p className="text-sm font-medium text-stone-600 mt-1">Buyurtma #{orderShortId}</p>
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        <div className="bg-white rounded-xl border border-stone-200 p-4 mb-4">
          <p className="text-xs font-medium text-stone-500 uppercase tracking-wide mb-4">Holat</p>
        ...
        <a href="#" className="flex items-center justify-center gap-2 w-full py-3 border border-stone-300 rounded-xl text-stone-700 font-medium hover:bg-stone-50 mb-6" onClick={(e) => e.preventDefault()}>
        ...
        <p className="text-xs text-stone-400 mt-4">Yangilanishi: har 5 soniyada</p>
      </main>
    </div>
  );
}
