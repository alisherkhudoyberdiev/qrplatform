...
// QR page: table selector 1–20, URL with table param, downloadable QR, print-friendly
...
export default function QRPage() {
  ...
  const menuUrl = origin
    ? selectedTable
      ? `${origin}/${locale}/menu/${restaurantId}/welcome?table=${selectedTable}`
      : `${origin}/${locale}/menu/${restaurantId}`
    : "";
